                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="Role name..." name="name"
                                   value="{{ ($old = old('name'))?$old:$role->name }}">
                        </div>
                    </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                @foreach($actions as $act)
                                    <div class="checkbox">
                                        <label>
                                            <input name="resource[]" value="{{ $act['id'] }}"
                                                   type="checkbox" {{ (in_array($act['id'], $permissions))?'checked="checked"':'' }}> {{ $act['name'] }}
                                        </label>
                                    </div>
                                @endforeach
                            </div>
